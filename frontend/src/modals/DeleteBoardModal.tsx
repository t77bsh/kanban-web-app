...
function DeleteBoardModal(props: Props) {
  ...
  return (
    <Modal>
      ...
      >
        <div className="text-2xl text-grey font-semibold">Delete Board</div>
        <div className="text-grey">
          Are you sure you want to delete this board? All related tasks and data
          would be deleted. This action cannot be undone.
        </div>
